...
/**
 * Props for the TeamEfficiencyTable component
 */
...
const DEFAULT_COLUMNS: TableColumn[] = [
  { title: '效能维度', dataIndex: 'efficiency_dimension', key: 'efficiency_dimension', width: 150, fixed: 'left' as const },
  { title: '关键场景', dataIndex: 'key_scenario', key: 'key_scenario', width: 200 },
  { title: '核心问题', dataIndex: 'core_problem', key: 'core_problem', width: 200 },
...
const DEFAULT_DATA: TableDataRow[] = [
  { key: 'row-0', efficiency_dimension: '知识结构', key_scenario: '', core_problem: '', key_reason: '', solution: '', ai_enablement: '' },
  { key: 'row-1', efficiency_dimension: '工作效率', key_scenario: '', core_problem: '', key_reason: '', solution: '', ai_enablement: '' },
  { key: 'row-2', efficiency_dimension: '时间管理', key_scenario: '', core_problem: '', key_reason: '', solution: '', ai_enablement: '' },
  { key: 'row-3', efficiency_dimension: '思维方式', key_scenario: '', core_problem: '', key_reason: '', solution: '', ai_enablement: '' },
  { key: 'row-4', efficiency_dimension: '激情状态', key_scenario: '', core_problem: '', key_reason: '', solution: '', ai_enablement: '' },
];


/**
 * TeamEfficiencyTable - A table component for team efficiency analysis
 * Supports editable cells, resizable columns/rows, and auto-save functionality
 */
const TeamEfficiencyTable: React.FC<TeamEfficiencyTableProps> = memo(function TeamEfficiencyTable({ fontSize = 14 }) {
  ...
  if (isLoading) {
    return (
      <Card title={<span style={{ fontSize: '16px' }}>团队效能分析表 (Team Efficiency Analysis)</span>} bordered={false} className="market-selection-card" styles={{ body: { padding: 0 } }}>
    ...
    <Card
      title={
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '16px' }}>团队效能分析表 (Team Efficiency Analysis)</span>
